...
def mostrar_asignaciones_territorio(numero_territorio):
    ...
    try:
        ...
        for fila in filas:
            ...
            print(f"   🗓 Asignado:   {fila['fecha_asignado'] or '—'}")
            print(f"   🗓 Completado: {fila['fecha_completado'] or '—'}")
            print(f"   🏠 Casas:     {fila['cantidad_abarcado'] or '—'}")
            print()
...
if __name__ == "__main__":
    num = input("Ingrese número lógico de territorio a consultar: ")
    if num.isdigit():
